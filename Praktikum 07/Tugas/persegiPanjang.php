...
<head>
    ...
    <title>Menghitung Persegi Panjang</title>
</head>

<body>
    <div class="container">
        <h1 class="text-center">Menghitung Persegi Panjang</h1>
        ...
        if (isset($_POST["submit"])) {
            ...
            $LuasPersegi=new persegipanjang($panjang, $lebar);
            echo "panjang :" . $LuasPersegi->$panjang() . "<br>";
            echo "lebar :" . $LuasPersegi->$lebar() . "<br>";
